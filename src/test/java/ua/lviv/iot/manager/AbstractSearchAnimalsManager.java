...
public abstract class AbstractSearchAnimalsManager {
	...
	public void joinLions() {
		...
		lions.add(new Lion(4, "lions", 2.3, 60, "women", 10, false, 25,24));
		lions.add(new Lion(2, "lions", 2.2, 70, "man", 12, true, 26,22));
		lions.add(new Lion(3, "lions", 2.1, 65, "women", 11, false, 27,23));
	}
